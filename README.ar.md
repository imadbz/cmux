...
<td width="40%" valign="middle">
<h3>محرر الأكواد</h3>
لوحة محرر أكواد مدمجة مبنية على Monaco مع مستكشف ملفات وتمييز بناء الجملة وحالة git. قسّمه بجانب الطرفية لتحرير الملفات دون مغادرة cmux.
</td>
<td width="60%">
