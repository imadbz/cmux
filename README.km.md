...
<td width="40%" valign="middle">
<h3>កម្មវិធីកែកូដ</h3>
ផ្ទាំងកែកូដដែលភ្ជាប់មកជាមួយ ដំណើរការដោយ Monaco ជាមួយកម្មវិធីរុករកឯកសារ ការបន្លិចវាក្យសម្ព័ន្ធ និងស្ថានភាព git។ បែងចែកវានៅក្បែរស្ថានីយរបស់អ្នកដើម្បីកែសម្រួលឯកសារដោយមិនចាំបាច់ចាកចេញពី cmux។
</td>
<td width="60%">
...
| ផ្លូវកាត់ (Shortcut) | សកម្មភាព (Action) |
|---|---|
| ⌘ ⇧ E | បើកកម្មវិធីកែកូដក្នុងការបែងចែក |
