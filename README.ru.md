...
<td width="40%" valign="middle">
<h3>Редактор кода</h3>
Встроенная панель редактора кода на базе Monaco с файловым обозревателем, подсветкой синтаксиса и статусом git. Разделите его рядом с терминалом, чтобы редактировать файлы, не покидая cmux.
</td>
<td width="60%">
...
| Сочетание | Действие |
|----------|--------|
| ⌘ ⇧ E | Открыть редактор в разделённом виде |
