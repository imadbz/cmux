...
<tr>
<td width="40%" valign="middle">
<h3>โปรแกรมแก้ไขโค้ด</h3>
แผงแก้ไขโค้ดในตัวที่ใช้ Monaco พร้อมตัวสำรวจไฟล์ การเน้นไวยากรณ์ และสถานะ git แบ่งหน้าจอข้างเทอร์มินัลเพื่อแก้ไขไฟล์โดยไม่ต้องออกจาก cmux
</td>
<td width="60%">
...
| ปุ่มลัด | การทำงาน |
|----------|--------|
| ⌘ ⇧ E | เปิดโปรแกรมแก้ไขในหน้าจอแบ่ง |
